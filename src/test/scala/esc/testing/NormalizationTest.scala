...
/**
 ...
 class NormalizationTest extends AnyFunSuite {
   ...
   test("Normalization.OrgName.1") {
       val normalizer = new NameNormalizer    
     assert(normalizer.normalizeOrganisationName("Huber Office (Schweiz) AG").normNames.toString == "Vector(Vector((huberoffice,1.0,1), (ch,0.5,3), (ag,0.25,2)), Vector((huber,1.0,1), (office,0.5,1), (ch,0.5,3), (ag,0.25,2)))")
   }
