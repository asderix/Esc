...
/**
  ...
  *
  * @param  normOrgLegalformWeight  Weight of a legal form match (recommended: < 1, default is 0.25).
  * @param  normOrgCountryWeight  Weight of a country match (recommended: < 1, default is 0.5).
